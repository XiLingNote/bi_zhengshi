 ...
 * Generated at: 2017-08-11 08:12:52 UTC
...
public final class wirelessFlowStructure_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Subject sub=SecurityUtils.getSubject();
      ...
      out.write("\t\t\t\t\t\t\t<span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span>Delete same-day\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      ...
      out.write("\t\t\t\t\t\t\timport template</a> <input type=\"file\" name=\"txt_file\" id=\"txt_file\"\r\n");
      ...
      out.write("\t\t\t\t\t<span class=\"deleteRows\"></span>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<a onclick=\"deleteByDate()\" class=\"btn btn-success\"\r\n");
      ...
      out.write("<script src=\"");
      out.print(basePath);
      out.write("/js/jquery.form-3.51.0.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(basePath);
      ...
      out.write("<script src=\"");
      out.print(basePath);
      out.write("/js/bootstrap/bootstrap-table-zh-CN.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(basePath);
      ...
      out.write("\tsrc=\"");
      out.print(basePath);
      out.write("/js/bootstrap/bootstrap-datetimepicker.zh-CN.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(basePath);
      ...
      out.write("<script src=\"");
      out.print(basePath);
      out.write("/js/bootstart-table-knockout.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(basePath);
      ...
      out.write("\r\n");
      out.write("        }); */\r\n");
      out.write("     var    tableTitleName=\"WirelessFlowStructure\";\r\n");
      out.write("        var role=");
      ...
      out.write("        \t$(\"#leftFlowStructure\").attr(\"class\", \"nav nav-third-level in\");\r\n");
      out.write("      \t  $(\"#leftwirless\").css(\"background\",\"#578EBE\");\r\n");
      ...
      out.print(basePath);
      out.write("wirelessFlowStructure/uploadWirelessFlowStructure.do\");\r\n");
      ...
      out.write("                url: \"");
      out.print(basePath);
      out.write("wirelessFlowStructure/queryWirelessFlowStructureByPage.do\", //获取数据的Servlet地址\r\n");
      ...
      out.write("                        url: \"");
      out.print(basePath);
      out.write("wirelessFlowStructure/updateWirelessFlowStructure.do\",\r\n");
      out.write("                        data: row,\r\n");
      ...
      out.write("                        date:$(\"#queryStartDate\").val(),\r\n");
      out.write("                    };\r\n");
      ...
      out.write("                \t/*初始查询条数用以删除显示提示用 */\r\n");
      out.write("               \t $(\".deleteRows\").text(this.totalRows+\" pieces of data on \"+$(\"#queryStartDate\").val());\r\n");
      out.write("                \t/* 表头提示 */\r\n");
      ...
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("            $('#cusTable').bootstrapTable('hideColumn', 'flowId');\r\n");
      out.write("            $('#cusTable').bootstrapTable('hideColumn', 'select');\r\n");
      out.write("        }\r\n");
      ...
      out.write("            \t\t  id: ko.observable(),\r\n");
      out.write("            \t\t  storename: ko.observable(),\r\n");
      out.write("            \t\t  date: ko.observable(),\r\n");
      out.write("            \t\t  payment: ko.observable()\r\n");
      out.write("            \t\t\t\t  };\r\n");
      ...
      out.write("            \t  if(!$(\"#queryStartDate\").val()){\r\n");
      out.write("            \t\t  toastr.warning(\"Please select the date\");\r\n");
      out.write("              \t\t  return;  \r\n");
      out.write("              \t  }\r\n");
      out.write("        \t    \tgetTitle(tableTitleName,role);\r\n");
      out.write("\r\n");
      out.write("            \t  if($('#cusTable').bootstrapTable('getData').length == 0){\r\n");
      out.write("            \t\t  toastr.warning(\"no Data\");\r\n");
      out.write("            \t\t  return;\r\n");
      out.write("            \t  }\r\n");
      out.write("        \t    \t//toastr.info('Are you sure you want to delete?<br /><br /><button onclick=\"deleteByDate()\" type=\"button\" class=\"btn clear\">Yes</button>');\r\n");
      ...
      out.write(" \r\n");
      out.write("          //数据校验\r\n");
      out.write("          operateCheck:function(arr){\r\n");
      out.write("              if (arr.length <= 0) {\r\n");
      out.write("                  alert(\"请至少选择一行数据\");\r\n");
      out.write("                  return false;\r\n");
      out.write("              }\r\n");
      out.write("              if (arr.length > 1) {\r\n");
      out.write("                  alert(\"只能编辑一行数据\");\r\n");
      out.write("                  return false;\r\n");
      out.write("              }\r\n");
      ...
      out.write("\t\t\ttodayButton:true\r\n");
      out.write("\t\t};\r\n");
      out.write("      function initDate(){\r\n");
      out.write("    \t  $(\"#datetimeStart>input[name = date ]\").datetimepicker(options);\r\n");
      ...
      out.write("    \t  \tvar viewmonth =(month>8)?(month+1):\"0\"+(month+1);\r\n");
      out.write("    \t  \t$('#datetimeStart>input[name = date ]').val(year + \"-\" + viewmonth+ \"-\" + day);\r\n");
      out.write("    \t    }\r\n");
      out.write("\r\n");
      out.write("      $(\"#datetimeStart>input[name = date ]\").datetimepicker(options).on('changeDate',\r\n");
      out.write("  \t\t\tfunction(ev) {\r\n");
      out.write("\t\t});\r\n");
      out.write("      $(\"#date\").datetimepicker(options).on('changeDate',\r\n");
      out.write("    \t\t\tfunction(ev) {\r\n");
      out.write("  \t\t});\r\n");
      ...
      out.write("\r\n");
      out.write("    \t\t    idArray[i]=val.flowId;  \r\n");
      out.write("\r\n");
      out.write("    \t\t});  \r\n");
      ...
      out.write("              url: \"");
      out.print(basePath);
      out.write("wirelessFlowStructure/deleteWirelessFlowStructureByBatch.do\",\r\n");
      out.write("              type: \"post\",\r\n");
      out.write("              data:a,\r\n");
      out.write("              success: function (data, status) {\r\n");
      out.write("\t\t\t\t\ttoastr.success(JSON.parse(data).data);\r\n");
      out.write("\r\n");
      out.write("            \t  $('#cusTable').bootstrapTable('remove', {field: 'flowId', values: idArray})\r\n");
      out.write("                \tif($('#cusTable').bootstrapTable('getData').length==0)\r\n");
      out.write("                    \tgetTitle(tableTitleName,role);\r\n");
      out.write("              }\r\n");
      out.write("          });\r\n");
      out.write("      }\r\n");
      out.write("      //删除单日数据\r\n");
      out.write("      function deleteByDate(){\r\n");
      out.write("    \t  a={\"date\":$(\"#queryStartDate\").val()};\r\n");
      out.write("    \t  $.ajax({\r\n");
      out.write("              url: \r\n");
      out.write("            \t  \"");
      out.print(basePath);
      out.write("wirelessFlowStructure/deleteWirelessFlowStructure.do\",\r\n");
      out.write("\t\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\t\tdata : a,\r\n");
      out.write("\t\t\t\t\tsuccess : function(data, status) {\r\n");
      out.write("\t\t\t\t\t\ttoastr.success(JSON.parse(data).data)\r\n");
