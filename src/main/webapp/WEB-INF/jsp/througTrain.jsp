...
<script>
      /*   $(document).ready(function(){
        ...
        var tableTitleName="througTrain";
        ...
        function initTable(tableTitle) {
            ...
            $("#cusTable").bootstrapTable({
                ...
                url: "<%=basePath%>througTrain/queryThrougTrainByPage.do", //获取数据的Servlet地址
                striped: true,  //表格显示条纹
                ...
                onEditableSave: function (field, row, oldValue, $el) {
                    $.ajax({
                        type: "post",
                        url: "<%=basePath%>througTrain/updateThrougTrain.do",
                        data: row,
                        dataType: 'JSON',
    ...
    //初始化fileinput
      ...
      $(function() {
    	  ...
    	  $("#leftPayData").attr("class", "nav nav-third-level in"); 
    	  $("#leftThrougTrain").css("background","#578EBE");
      	getTitle(tableTitleName,role);
    	//初始化表格
      	//日期初始化
      	initDate();
      	...
      	operate.operateInit();
      	//初始化上传文件
           inportInit("txt_file", "<%=basePath%>througTrain/uploadThrougTrain.do");
  	//	pandora潘多拉官方旗舰店
      ...
      function deleteByArray(){
    	...
    	var a=  {"idArray":idArray};
          $.ajax({
              url: "<%=basePath%>througTrain/deleteThrougTrainByBatch.do",
              type: "post",
              data:a,
              success: function (data, status) {
