...
<script>
      /*   $(document).ready(function(){
        ...
        function initTable(tableTitle) {
            ...
            $("#cusTable").bootstrapTable({
                ...
                url: "<%=basePath%>drillShow/queryDrillShowByPage.do", //获取数据的Servlet地址
                striped: true,  //表格显示条纹
                ...
                onEditableSave: function (field, row, oldValue, $el) {
                    $.ajax({
                        type: "post",
                        url: "<%=basePath%>drillShow/updateDrillShow.do",
                        data: row,
                        dataType: 'JSON',
    ...
    //初始化fileinput
      ...
      $(function() {
    	  ...
    	  $("#leftPayData").attr("class", "nav nav-thrid-level in"); 
    	  $("#leftDrillShow").css("background","#578EBE");
      	getTitle(tableTitleName,role);
    	//初始化表格
      	//日期初始化
      	initDate();
      	...
      	operate.operateInit();
      	//初始化上传文件
           inportInit("txt_file", "<%=basePath%>drillShow/uploadDrillShow.do");
  	//	pandora潘多拉官方旗舰店
      ...
      function deleteByArray(){
    	...
    	var a=  {"idArray":idArray};
          $.ajax({
              url: "<%=basePath%>drillShow/deleteDrillShowByBatch.do",
              type: "post",
              data:a,
              success: function (data, status) {
