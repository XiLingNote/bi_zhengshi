...
(function (t, e) {
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
            ...
            return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", le + "-state-highlight") : r > t ? o.push("fc-past") : o.push("fc-future"), a += "<td class='" + o.join(" ") + "'" + " data-date='" + xe(t, "yyyy-MM-dd") + "'" + ">" + "<div>", re && (a += "<div class='fc-day-number'>" + t.getDate() + "</div>"), a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div>  "+ "<div type='text' class = 'daliy' style=' width: 100% ' id='" + xe(t, "yyyy-MM-dd") + "'" + " > <input type='text' class='dailyId'  style='display: none ' ><input type='text' class='dailyPayment' placeholder='no Data' maxlength='10'  style=';display:none;border:1px solid rgba(0, 0, 0, 0) '></div>" +"</div></td>"
        }
    ...
    var Ce = {
        ...
        startParam: "start",
        endParam: "end",
        titleFormat: {month: "yyyy-MMMM", week: "yyyy-MMMM-d{'&#8212;'d}", day: "yyyy-MMMM-d dddd"},
