    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if(this.totalPages>0){
                var toPageArray=new Array;  
                for(var iii = 1; iii<=this.totalPages; iii++){  
                	toPageArray.push("&quot;"+iii+"&quot;");  
                }  
                html.push(
                    '<li class="page-next"><a href="#">' + this.options.paginationNextText + '</a></li>',
                    '<li>Page <input type="number" min="1" max='+this.totalPages+' value='+this.options.pageNumber+' id="toPage"  autocomplete="off"   data-items="1" style="width:60px;"  data-source=['+toPageArray+'] /> <input type=button onclick="goToPage()" value="go"></input></li></ul>','</div>');
            	}
            else{
            html.push(
                '<li class="page-next"><a href="#">' + this.options.paginationNextText + '</a></li>',
